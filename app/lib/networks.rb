...
# This maps TV Maze networks to our network names
TV_MAZE_MAP = {
 "CBS"=>"CBS",
 "NBC"=>"NBC",
 "ABC"=>"ABC",
 ...
 "USA Network"=>"USAHD",
 "ESPN"=>"ESPNHD",
 "Cartoon Network"=>"TOONHD",
 "Adult Swim"=>"TOONHD",
 "Nickelodeon"=>"NIK",
 "Nick Jr."=>"NIK",
 "FOX News Channel"=>"FNCHD",
 "CNN"=>"CNNHD",
 "Bravo"=>"BRAVOHD",
 "ESPN2"=>"ESPN2HD",
 "History"=>"HISTE",
 ...
 "HGTV"=>"HGTVD",
 "Oprah Winfrey Network"=>"OWNHD",
 "CBS Sports Network"=>"CBSSNHD",
 "ESPN"=>"ESPNUHD",
 "NBCSN"=>"NBCSNHD",
 "Disney Channel"=>"DISNHD",
 "National Geographic Channel"=>"NGWIHD",
 "National Geographic WILD"=>"NGWIHD",
 "Oxygen"=>"OXYGNHD",
 "IFC"=>"IFCHD",
 "MSG"=>"MSGHD",
 "__YESHDNY"=>"YESHDNY",
